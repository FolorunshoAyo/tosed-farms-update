...
<head>
    <meta charset="utf-8" />
    <title>Feed Ingredients - Tosed Integrated Farm Ventures</title>
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Feed Ingredients</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Feed Ingredients</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-box table-responsive">
                                ...
                                <div class="mt-4 text-right">
                                    <a href="<?= BASE_URL ?>/admin/products/unbranded/feed-ingredient/new" class="btn btn-primary waves-effect waves-light"> 
                                        <i class="fas fa-plus mr-1"></i> <span>Add New Feed Ingredient</span> 
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                  <form id="editBrandForm" method="post" action="<?= BASE_URL ?>/admin/products/unbranded/feed-ingredient/edit" onsubmit="return validateForm()">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input required id="manufacturer" name="manufacturer" type="text" class="form-control" placeholder="Enter Brand Name e.g Kepro">
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form id="productActionForm" action="<?= BASE_URL ?>/admin/products/unbranded/feed-ingredients/delete" method="post">
