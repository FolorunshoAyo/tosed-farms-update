            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-sm-6 text-center">
                    ...
                    <div class="wrapper-page">
                        <img src="<?= BASE_URL ?>/admin-assets/images/animat-search-color.gif" alt="" height="120">
                        ...
                        <a class="btn btn-success waves-effect waves-light mt-4" href="index-2.html"> Return Home</a>
                    </div>
                </div>
