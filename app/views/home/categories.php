        ...
        <div class="sections services-background">
            <div class="container">
                <div class="pages-title">
                    <h1>Our <br> <span>Categories</span></h1>
                    <p><a href="<?= BASE_URL ?>/">Home</a> &nbsp; > &nbsp; Categories</p>
                </div>
            </div>
        </div>
        ...
        <section>
            <div class="container">
                <div class="section-title">
                    ...
                    <p>Discover our collection of high-quality livestock products from leading brands/manufacturers. Trusted by farmers and veterinarians for superior products and expertise in the livestock industry.</p>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4" data-aos='fade-up'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/poultry-feeds" class="overlay"></a>  
                    ...
                    <div class="col-md-6 col-lg-4" data-aos='fade-up' data-aos-delay='50'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/fish-feeds" class="overlay"></a>  
                          <i class="fas fa-fish service-icon"></i>
                          <div class="caption">
                              <h3>Fish Feeds</h3>
                              <p>There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                          </div>
                    ...
                    <div class="col-md-6 col-lg-4" data-aos='fade-up' data-aos-delay='100'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/veterinary-products" class="overlay"></a>  
                          <i class="fas fa-syringe service-icon"></i>
                          <div class="caption">
                              <h3>Veterinary Drugs</h3>
                              <p>There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                          </div>
                      </div>  
                    </div>
                    <div class="col-md-6 col-lg-4" data-aos='fade-up' data-aos-delay='150'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/feed-additives" class="overlay"></a>  
                    ...
                    <div class="col-md-6 col-lg-4" data-aos='fade-up' data-aos-delay='200'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/feed-ingredients" class="overlay"></a>  
                          <i class="fas fa-seedling service-icon"></i>
                          <div class="caption">
                              <h3>Feed Ingredients</h3>
                              <p>There are many variations of passages of Lorem Ipsum available, but the majority.</p>
                          </div>
                      </div>  
                    </div>
                    <div class="col-md-6 col-lg-4" data-aos='fade-up' data-aos-delay='250'>
                      <div class="box-services">
                          <a href="<?= BASE_URL ?>/category/miscellaneous" class="overlay"></a>  
