...
<html lang="en-US" class="no-js">
  ...
  <head>
    ...
    TITLE AND META TAGS
    =============================================== -->
    <title>Request For Invoice Success | Tosed Farms</title>
        ...
        <div class="sections">
            <div class="container">
                <div class="pages-title">
                    <h1>Request For Invoice<br> <span>Success</span></h1>
                    <p><a href="<?= BASE_URL ?>/">Home</a> &nbsp; > &nbsp; Request For Quote</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card bg-white shadow p-3">
                            ...
                            <div class="text-center">
                                <h3>Invoice Request Received Successfully</h3>
                                <p class="my-2" style="font-size: 0.6rem;">Thank you for your inquiry! We have received your request and will get back to you shortly with a personalized quote tailored to your needs. We appreciate your interest in our products/services.</p>
                                <a href="<?= BASE_URL ?>/" class="btn btn-custom btn-success">Back Home</a>
                            </div>
                        </div>
                    </div>
                </div>
