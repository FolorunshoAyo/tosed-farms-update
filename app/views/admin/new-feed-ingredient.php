...
<head>
    <meta charset="utf-8" />
    <title>New Feed Ingredient | Tosed Integrated Farm Ventures</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/admin/products/unbranded/feed-ingredients">Feed Ingredients</a></li>
                                        <li class="breadcrumb-item active">New Feed Ingredient</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">New Feed Ingredient</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="header-title">Create New Feed Ingredient</h4>
                                <p class="sub-header">
                                    Create a new feed ingredient for your collection below.
                                </p>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <form class="form-horizontal" action="<?= BASE_URL ?>/admin/products/unbranded/feed-ingredient/new" method="post" onsubmit="return validateForm()">
                                            <!-- Image placholder here -->
                                            <div class="form-group row">
                                                <label for="name" class="col-md-2 control-label">Name</label>
                                                <div class="col-md-10">
                                                    <input id="name" type="text" name="name" class="form-control" placeholder="Enter Product Name e.g PKC" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 text-right">
                                                <button class="btn btn-primary waves-effect waves-light"> 
                                                    <i class="fas fa-plus mr-1"></i> <span>Add Feed Ingredient</span> 
                                                </button>
                                            </div>
                                        </form>
                                    </div>
