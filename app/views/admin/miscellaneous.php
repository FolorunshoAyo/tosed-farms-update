                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card-box table-responsive">
                                ...
                                <div class="mt-4 text-right">
                                    <a href="<?= BASE_URL ?>/admin/products/unbranded/miscellaneous/new" class="btn btn-primary waves-effect waves-light"> 
                                        <i class="fas fa-plus mr-1"></i> <span>Add New Miscellaneous Product</span> 
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="editBrandForm" method="post" action="<?= BASE_URL ?>/admin/products/unbranded/miscellaneous/edit" onsubmit="return validateForm()">
                    <div class="form-group row">
                        <label for="name" class="col-md-2 control-label">Name</label>
                        <div class="col-md-10">
                            <input id="name" name="name" type="text" class="form-control" placeholder="Enter Product Name e.g Drinker" required>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <form id="productActionForm" action="<?= BASE_URL ?>/admin/products/unbranded/miscellaneous/delete" method="post">
